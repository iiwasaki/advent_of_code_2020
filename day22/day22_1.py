"""
Play a round of Combat with this crab in front of you.
"""
...
def play_combat(p1_deck, p2_deck):
    """
    Simulates a game of Combat given two decks. First player to get all
    of the cards in their deck wins.
    """
    round = 1
...
if __name__ == "__main__":
    ...
    score = play_combat (p1_deck, p2_deck)
