"""
Simulates six cycles of this cube bootup.. thing?
"""

from modifier_sets import MODIFIER_SET_3D
...
def fill_neighbors(cube, active_neighbors, active):
    ...
    y_coord = cube[1]
    z_coord = cube[2]
    for modifier in MODIFIER_SET_3D:
